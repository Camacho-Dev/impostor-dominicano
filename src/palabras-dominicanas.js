...
export const palabrasDominicanas = {
  ...
  comida: [
    ...
    { palabra: "La Bandera", pistas: ["Mediodía", "Tres colores", "Arroz"] },
    { palabra: "Sancocho", pistas: ["Reunión", "Leña", "Domingo"] },
    { palabra: "Tostones", pistas: ["Dos veces", "Aceite", "Verde"] },
    { palabra: "Yaroa", pistas: ["Santiago", "Queso", "Capas"] },
    ...
    { palabra: "Pasteles en hoja", pistas: ["Navidad", "Plátano envuelto", "Vapor"] },
    { palabra: "Queso de hoja", pistas: ["Blanco", "Derretido", "Suave"] },
    { palabra: "Chuleta ahumada", pistas: ["Humo", "Salazón", "Cerdo"] },
    { palabra: "Pernil", pistas: ["Nochebuena", "Horno", "Cerdo"] },
    { palabra: "Tacacho", pistas: ["Plátano", "Relleno", "Frito"] },
    { palabra: "Yaniqueque", pistas: ["Frito", "Relleno", "Harina de trigo"] },
    { palabra: "Empanada", pistas: ["Rellena", "Frita", "Masa"] },
    { palabra: "Catibías", pistas: ["Yuca rallada", "Coco", "Horno"] },
    { palabra: "Bolos de coco", pistas: ["Dulce", "Coco", "Calle"] },
    { palabra: "Dulce de leche cortada", pistas: ["Granulado", "Dulce", "Leche"] },
    { palabra: "Maíz caquiao", pistas: ["Grano", "Hervido", "Sal"] },
    { palabra: "Bizcocho dominicano", pistas: ["Boda", "Crema", "Blanco"] },
    { palabra: "Flan de coco", pistas: ["Postre", "Suave", "Dulce"] },
    { palabra: "Caldo de pollo", pistas: ["Sopa", "Amarillo", "Resfriado"] },
    { palabra: "Guandules con coco", pistas: ["Navidad", "Verde", "Arroz"] },
    { palabra: "Rabo encendido", pistas: ["Cola", "Picante", "Rojo"] },
    { palabra: "Chenchén", pistas: ["Maíz", "Santiago", "Cibao"] },
    { palabra: "Moro de habichuelas", pistas: ["Mezclado", "Rojo", "Arroz"] },
    { palabra: "Níspero", pistas: ["Marrón", "Dulce", "Árbol"] },
    { palabra: "Tamarindo", pistas: ["Ácido", "Marrón", "Vaina"] },
    { palabra: "Bollo", pistas: ["Hoja", "Hervido", "Mañana"] },
    { palabra: "Pan de agua", pistas: ["Cruce", "Largo", "Desayuno"] },
    { palabra: "Chicharrón de pollo", pistas: ["Crujiente", "Frito", "Colmado"] },
    { palabra: "Arepa", pistas: ["Maíz", "Coco", "Canela"] },
    { palabra: "Majarete", pistas: ["Maíz", "Canela", "Postre"] },
    { palabra: "Dulce de coco", pistas: ["Cortado", "Blanco", "Cuaresma"] },
    { palabra: "Coco frio", pistas: ["Playa", "Agua", "Verde"] },
    { palabra: "Mabí", pistas: ["Corteza", "Fermentado", "Amargo"] },
    { palabra: "Jugo de avena", pistas: ["Frío", "Crema", "Calle"] },
    { palabra: "Pica pica", pistas: ["Mariscos", "Picante", "Playa"] },
    { palabra: "Lambí", pistas: ["Concha", "Caracol", "Mar"] },
    { palabra: "Chivo liniero", pistas: ["Carretera", "Norte", "Asado"] },
    { palabra: "Tres golpes", pistas: ["Mangú", "Huevo", "Queso"] },
    { palabra: "Café con leche", pistas: ["Mañana", "Colado", "Taza"] },
    { palabra: "Mazamorra", pistas: ["Maíz", "Dulce", "Crema"] },
    { palabra: "Suspiro", pistas: ["Merengue", "Dulce", "Horno"] },
    { palabra: "Dulce de batata", pistas: ["Morado", "Cuaresma", "Blanco"] },
    { palabra: "Té de jengibre", pistas: ["Caliente", "Picante", "Gripe"] },
  ],
  ...
  historia: [
    ...
    { palabra: "El Corte", pistas: ["Masacre", "Río", "Haitianos"] },
    { palabra: "La Era de Trujillo", pistas: ["30 años", "Control", "Terror"] },
    { palabra: "Espaillat", pistas: ["General", "Norte", "Presidente"] },
    { palabra: "Pedro Santana", pistas: ["Traición", "Anexión", "Primera"] },
    { palabra: "Buenaventura Báez", pistas: ["Varias veces", "Ambición", "Venta"] },
    { palabra: "La Matanza de 1937", pistas: ["Perejil", "Río", "Masacre"] },
    { palabra: "Máximo Gómez", pistas: ["Cuba", "Dominicano", "General"] },
    { palabra: "Palacio Nacional", pistas: ["Mármol", "Gobierno", "Centro"] },
    { palabra: "Altar de la Patria", pistas: ["Tres", "Parque", "Sombras"] },
    { palabra: "Batalla de Azua", pistas: ["Sur", "1844", "Retirada"] },
    { palabra: "Batalla de La Estrelleta", pistas: ["Mella", "Oeste", "Frontera"] },
  ],
  ...
  lugares: [
    ...
    { palabra: "Puerto Plata", pistas: ["Cable", "Teleférico", "Norte"] },
    { palabra: "La Romana", pistas: ["Caña", "Casa de Campo", "Este"] },
    { palabra: "San Pedro de Macorís", pistas: ["Peloteros", "Este", "Ingenio"] },
    { palabra: "Bonao", pistas: ["Níquel", "Centro", "Autopista"] },
    { palabra: "Mao", pistas: ["Valverde", "Noroeste", "Arroz"] },
    { palabra: "Monte Cristi", pistas: ["Sombrero", "Noroeste", "Árido"] },
    { palabra: "Higüey", pistas: ["Basílica", "Este", "Altagracia"] },
    { palabra: "Azua", pistas: ["Calor", "Sur", "Melocotón"] },
    { palabra: "Moca", pistas: ["Café", "Espaillat", "Norte"] },
    { palabra: "Cotuí", pistas: ["Oro", "Sánchez Ramírez", "Minería"] },
    { palabra: "Isla Catalina", pistas: ["Buceo", "Turistas", "Este"] },
    { palabra: "Las Terrenas", pistas: ["Extranjeros", "Samaná", "Playa"] },
    { palabra: "Cayo Levantado", pistas: ["Ron Barceló", "Isla pequeña", "Samaná"] },
    { palabra: "Parque del Este", pistas: ["Manatíes", "Cueva", "Sur este"] },
    { palabra: "El Monumento", pistas: ["Restauración", "Santiago", "Alto"] },
  ],
  ...
  personajes: [
    ...
    { palabra: "Manny Ramírez", pistas: ["Pelo largo", "Raro", "Bateador"] },
    { palabra: "Robinson Canó", pistas: ["Suave", "Yankees", "Suspensión"] },
    { palabra: "Juan Soto", pistas: ["Millones", "Joven", "Paciencia"] },
    { palabra: "Vladimir Guerrero", pistas: ["Brazo", "Bateador de todo", "Salcedo"] },
    { palabra: "Darvish", pistas: ["Pitcheo", "Japonés dominicano", "Raro"] },
    { palabra: "Luisa Ozema", pistas: ["Atletismo", "Velocidad", "Mujer"] },
    { palabra: "Luichy Martinez Villanueva", pistas: ["Escultor", "Merengue", "Monumento"] },
    { palabra: "Porfirio Rubirosa", pistas: ["Diplomático", "Playboy", "Auto"] },
    { palabra: "Ámbar Heard", pistas: ["Falso", "No es dominicana", "Trampa"] },
    { palabra: "Carlos Santana", pistas: ["Primera base", "Cleveland", "Jonrón"] },
    { palabra: "Hanley Ramírez", pistas: ["Shortstop", "Talento", "Boston"] },
    { palabra: "Clarissa Molina", pistas: ["Presentadora", "Miss", "Televisión"] },
    { palabra: "Amelia Vega", pistas: ["Miss Universo", "2003", "Alta"] },
  ],
  ...
  artistas: [
    ...
    { palabra: "Omega el Fuerte", pistas: ["El hombre", "Merengue", "Mambo"] },
    { palabra: "Toño Rosario", pistas: ["Cucú", "Merengue", "Fiesta"] },
    { palabra: "Eddy Herrera", pistas: ["Romántico", "Amor", "Merengue suave"] },
    { palabra: "Sergio Vargas", pistas: ["La guandulera", "Clásico", "Merengue"] },
    { palabra: "Milly Quezada", pistas: ["Reina", "Merengue", "Mujer"] },
    { palabra: "Kinito Méndez", pistas: ["Cachamba", "Humor", "Merengue"] },
    { palabra: "Víctor Víctor", pistas: ["Canción protesta", "Trovador", "Social"] },
    { palabra: "Cacao", pistas: ["Barrio", "Dembow", "Popular"] },
    { palabra: "Chimbala", pistas: ["Urban", "Viral", "Carisma"] },
    { palabra: "Rochy RD", pistas: ["Dembow", "Letras", "Urbano"] },
    { palabra: "La Materialista", pistas: ["Dinero", "Urbana", "Mujer"] },
    { palabra: "Lápiz Conciente", pistas: ["Rap", "Conciencia", "Letras"] },
    { palabra: "Mozart La Para", pistas: ["Urbano", "Barrio", "Dominicano"] },
  ],
  ...
  musica: [
    ...
    { palabra: "A media asta", pistas: ["Bandera", "Luto", "Tristeza"] },
    { palabra: "El costo de la vida", pistas: ["Caro", "Queja", "Realidad"] },
    { palabra: "Nuestro juramento", pistas: ["Julio Jaramillo", "Promesa", "Llanto"] },
    { palabra: "Burbujas de amor", pistas: ["Mar", "Sumergido", "Romance"] },
    { palabra: "Rosalina", pistas: ["Clásica", "Letra cómica", "Merengue"] },
    { palabra: "El africano", pistas: ["Baile", "Chibiri", "Popular"] },
    { palabra: "Me voy pa la capital", pistas: ["Campo", "Sueño", "Mudarse"] },
    { palabra: "Compadre Pedro Juan", pistas: ["Típico", "Cibaeño", "Fiestas"] },
    { palabra: "Suavemente", pistas: ["Beso", "Elvis Crespo", "Popular"] },
    { palabra: "Pegao", pistas: ["Wisin", "Ritmo", "Pegajoso"] },
    { palabra: "Loco contigo", pistas: ["DJ Snake", "Colaboración", "Internacional"] },
    { palabra: "Mayores", pistas: ["Becky G", "Urbano", "Colaboración"] },
    { palabra: "Canoa", pistas: ["Tradicional", "Agua", "Remar"] },
    { palabra: "Palo echao", pistas: ["Típico", "Cibao", "Fuelle"] },
    { palabra: "Pri-prí", pistas: ["Pájaro", "Canto", "Endémico"] },
    { palabra: "La canción del alma", pistas: ["Juan Luis", "Lluvia", "Café"] },
    { palabra: "El niágara en bicicleta", pistas: ["Hospital", "Juan Luis", "Crítica"] },
    { palabra: "Bachata rosa", pistas: ["Álbum", "Grammy", "Juan Luis"] },
    { palabra: "Acompáñame", pistas: ["Anthony Santos", "Romántica", "Guitarra"] },
    { palabra: "Danza kuduro", pistas: ["Don Omar", "Reggaeton", "Baile"] },
    { palabra: "Propuesta indecente", pistas: ["Romeo", "Bachata", "Viral"] },
    { palabra: "Despacito", pistas: ["Luis Fonsi", "Puerto Rico", "Colaboración"] },
  ],
  ...
  deportes: [
    ...
    { palabra: "Gigantes del Cibao", pistas: ["San Francisco", "Cibao", "Naranja"] },
    { palabra: "Estrellas Orientales", pistas: ["San Pedro", "Este", "Estrellas"] },
    { palabra: "Toros del Este", pistas: ["La Romana", "Toro", "Nuevo"] },
    { palabra: "Escogido", pistas: ["Rojo", "Capital", "Rival del Licey"] },
    { palabra: "Manny Machado", pistas: ["Tercera base", "San Diego", "Elegante"] },
    { palabra: "Robinson Canó", pistas: ["Segunda", "Suave", "Yankees"] },
    { palabra: "Vladimir Guerrero Jr.", pistas: ["Hijo", "Toronto", "Primera base"] },
    { palabra: "Jordán Díaz", pistas: ["Joven", "Oakland", "Prometedor"] },
    { palabra: "Pelota de goma", pistas: ["Calle", "Sin guante", "Barrio"] },
    { palabra: "La Academia", pistas: ["Jugadores", "Fábrica", "Sueño grande"] },
    { palabra: "Lucha olímpica", pistas: ["Tapete", "Fuerza", "Medalla"] },
    { palabra: "Boxeo dominicano", pistas: ["Guante", "Ring", "Campeón"] },
  ],

  festividades: [
    { palabra: "Carnaval", pistas: ["Disfraz", "Vejiga", "Calle"] },
    { palabra: "Diablo Cojuelo", pistas: ["Espejo", "Cuernos", "Golpe"] },
    { palabra: "Semana Santa", pistas: ["Procesión", "Bacalao", "Velas"] },
    ...
    { palabra: "Nochebuena", pistas: ["24", "Pernil", "Familia reunida"] },
    { palabra: "Fin de año", pistas: ["12 uvas", "Cohetes", "Maletas"] },
    { palabra: "Día de las Madres", pistas: ["Mayo", "Flores", "Restaurante lleno"] },
    { palabra: "Carnaval de Monte Cristi", pistas: ["Toros", "Norte", "Pelea"] },
    { palabra: "Festival del Merengue", pistas: ["Malecón", "Orquestas", "Agosto"] },
    { palabra: "Festival de la Bachata", pistas: ["Boca Chica", "Guitarra", "Verano"] },
    { palabra: "Semana Deportiva Nacional", pistas: ["Atletas", "Feriado", "Agosto"] },
    { palabra: "Procesión de Semana Santa", pistas: ["Cargando", "Calle", "Velas"] },
    { palabra: "Misa del Gallo", pistas: ["Medianoche", "Diciembre", "Iglesia"] },
  ],
  ...
  tradiciones: [
    ...
    { palabra: "El Bacá", pistas: ["Pacto", "Oscuro", "Diablo"] },
    ...
    { palabra: "La boda dominicana", pistas: ["Toda la noche", "Mucha comida", "Familia entera"] },
    { palabra: "Dar la bendición", pistas: ["Mayores", "Saludo", "Respeto"] },
    { palabra: "El guagüero", pistas: ["Bus", "Rápido", "Carretera"] },
    { palabra: "El apagón", pistas: ["Oscuro", "Vela", "Generador"] },
    { palabra: "Fuá", pistas: ["Golpe", "Rápido", "Expresión"] },
    { palabra: "Ñoño", pistas: ["Travieso", "Niño", "Calle"] },
    { palabra: "Bochinche", pistas: ["Chisme", "Bulla", "Vecina"] },
    { palabra: "El sanky", pistas: ["Turista", "Playa", "Visa"] },
    { palabra: "Echar una paloma", pistas: ["Carta", "Mensaje", "Secreto"] },
    { palabra: "La hora dominicana", pistas: ["Tarde", "Nunca a tiempo", "Clásico"] },
    { palabra: "La guagua", pistas: ["Bus", "Lleno", "Transporte"] },
    { palabra: "El concho", pistas: ["Taxi", "Ruta", "Compartido"] },
    { palabra: "Hacer la barba", pistas: ["Adulación", "Jefe", "Pelota"] },
    { palabra: "Tiguere de batey", pistas: ["Duro", "Caña", "Respeto"] },
    { palabra: "Fiao", pistas: ["Crédito", "Colmado", "Deuda"] },
    { palabra: "La piña", pistas: ["Problema", "Pelea", "Calle"] },
    { palabra: "Vergüenza", pistas: ["Pena", "No hacer", "Respeto"] },
    { palabra: "Un chin", pistas: ["Un poco", "Cantidad", "Dominicano"] },
    { palabra: "Chopear", pistas: ["Comprar", "Gastar", "Dinero"] },
    { palabra: "Vergador", pistas: ["Fiesta", "Alcohol", "Rumba"] },
    { palabra: "Yala", pistas: ["Ok", "De acuerdo", "Calle"] },
    { palabra: "Dame un break", pistas: ["Pausa", "Inglés", "Descanso"] },
    { palabra: "Pégate", pistas: ["Acércate", "Ven", "Invitación"] },
    { palabra: "Vacilar", pistas: ["Diversión", "Pasarla bien", "Rumba"] },
  ],
  ...
  barrios: [
    ...
    { palabra: "Alma Rosa", pistas: ["Este", "Residencial", "Popular"] },
    { palabra: "Luperón", pistas: ["Norte capital", "Popular", "Bullicioso"] },
    { palabra: "Domingo Savio", pistas: ["Norte", "Denso", "Capital"] },
    { palabra: "La Zurza", pistas: ["Norte", "Ozama", "Popular"] },
    { palabra: "Barrio Chino", pistas: ["Migrantes", "Tiendas", "Antiguo"] },
    { palabra: "Mirador Norte", pistas: ["Parque", "Norte", "Correr"] },
    { palabra: "Mirador Sur", pistas: ["Parque", "Sur", "Ejercicio"] },
    { palabra: "El Millón", pistas: ["Norte", "Popular", "Transitado"] },
    { palabra: "Las Caobas", pistas: ["Sur", "Residencial", "Tranquilo"] },
    { palabra: "Ensanche Naco", pistas: ["Lujoso", "Capital", "Zona rosa"] },
    { palabra: "Bella Vista", pistas: ["Residencial", "Sur capital", "Elegante"] },
    { palabra: "El Pedregal", pistas: ["Norte", "Popular", "Capital"] },
    { palabra: "Pantoja", pistas: ["Norte", "Industrial", "Popular"] },
  ],
  ...
  marcas: [
    ...
    { palabra: "Cubanito 18", pistas: ["Ron barato", "Cartón", "Fiesta pobre"] },
    { palabra: "Suplidores Económicos", pistas: ["Electrónica", "Barato", "Santiago"] },
    { palabra: "Apap", pistas: ["Banco", "Ahorro", "Préstamo"] },
    { palabra: "BHD León", pistas: ["Banco", "Azul", "Privado"] },
    { palabra: "Tropical", pistas: ["Leche", "Vaca", "Naranja"] },
    { palabra: "Quisqueya", pistas: ["Agua", "Botella", "Nacional"] },
    { palabra: "Pola", pistas: ["Supermercado", "Santiago", "Norte"] },
    { palabra: "Palacio del Cine", pistas: ["Película", "Palomitas", "Mall"] },
    { palabra: "Viva", pistas: ["Telefonía", "Verde", "Tercera"] },
    { palabra: "Wind Telecom", pistas: ["Internet", "Fibra", "Hogar"] },
    { palabra: "Helados Bon", pistas: ["Barquillo", "Vainilla", "Dominicano"] },
    { palabra: "Pollo Rey", pistas: ["Pollo", "Amarillo", "Económico"] },
    { palabra: "Pollos Victorina", pistas: ["Asado", "Avenida", "Clásico"] },
  ],
  ...
  youtubers: [
    ...
    { palabra: "Mister Franky", pistas: ["Reacciones", "YouTube", "Entretenimiento"] },
    { palabra: "El Churry", pistas: ["Comedia", "Personajes", "Popular"] },
    { palabra: "El Hombre sin Nombre", pistas: ["Misterio", "Análisis", "Dominicano"] },
    { palabra: "Klandestino Manny", pistas: ["Farándula", "Chisme", "Redes"] },
    { palabra: "D'Blanco y D'Negro", pistas: ["Dúo", "Comedia", "TV"] },
    { palabra: "El Pachá", pistas: ["TV", "Farándula", "Escándalo"] },
    { palabra: "Héctor J", pistas: ["Comedia", "Viral", "Joven"] },
    { palabra: "El Guía Dominicano", pistas: ["Turismo", "Playas", "Vlog"] },
  ],
};
